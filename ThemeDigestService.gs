 ...
 * ============================================================================
 * PROJETO: Scafframe
 * TEMA: Cinema e cineclube escolar
 *
 * DESCRIÇÃO:
...
var THEME_NEWS_CFG = {
  THEME: 'Cinema e cineclube escolar',
  QUERY: 'cineclube OR "cinema na educacao"',
  AUDIENCE: 'estudantes do cine clube Horizontes Animados que escrevem criticas de filmes',

...
function gw_login_(username, password) {
  try {
    ...
    if (typeof AuthStd_loginWithToken_ === 'function') entries.push(function (form) { return AuthStd_loginWithToken_.apply(null, form); });        entries.push(function (form) { return authenticate.apply(null, form); });
